...
<nav class="navbar navbar-default navbar-static-top" id="navigation" style="min-height: 100px">
    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12  " >
        <div class="col-md-6">
            ...
            <a href="{{route('welcome')}}" > <img src="{{asset('images/logo.png')}}" alt="logo" title="logo" class="img-responsive " style="height:70px; margin:0; padding:4% 0 0 2%" > </a>
        </div>
